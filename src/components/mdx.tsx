...
function CustomLink({ href, children, ...props }: CustomLinkProps) {
  ...
  if (href.startsWith("/")) {
    return (<SmartLink href={href} aria-label={ariaLabel} {...props}>{children}</SmartLink>);}
...
function createImage({ alt, src, ...props }: SmartImageProps & { src: string }) {if (!src) {console.error("SmartImage requires a valid 'src' property.");return null;} 

// Add more robust logging and path resolution
console.log("Image Source:", src);

return (<SmartImage className="my-20" isLoading radius="m" aspectRatio="16/9" alt={alt} src={src} {...props}/>);}
