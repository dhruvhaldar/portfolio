...
export const alt = "Portfolio OpenGraph Image";
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        <div
          style={{
            ...
            width: "150%",
            height: "150%",
            background: "radial-gradient(circle, rgba(8, 169, 124, 0.2) 0%, rgba(4, 8, 22, 0) 70%)",
            zIndex: 0,
          }}
        />
        ...
        <div style={{
          ...
          <div style={{ width: "8px", height: "8px", borderRadius: "50%", background: colors.emerald[600] }}></div>
