...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: ogImage, width: 1200, height: 630, alt: alt_title }],
    },
    twitter: {
    ...
    <Column maxWidth="m" gap="xl" horizontal="center">
      ...
      {routes["/blog"] && (
        <Flex fillWidth gap="24" mobileDirection="column">
          <Flex flex={1} paddingLeft="l"><Heading as="h1" variant="display-strong-xs" wrap="balance">Latest from the blog</Heading></Flex><Flex flex={3} paddingX="20"><Posts range={[1, 2]} columns="2" /></Flex></Flex>)}<Projects range={[2]} /></Column>);}
